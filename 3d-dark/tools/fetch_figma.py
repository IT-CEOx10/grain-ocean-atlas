...
PNG = {
    ...
    # Финал: коллаж из диагональных полос (кадр 21-people).
    #
    # НЕ СКАЧИВАТЬ. 22.09 заказчик прислал свой исходник коллажа
    # (2000x1127, более свежая версия: добавлены трактор с сеялкой
    # и женщина в красной косынке). Он лежит в assets/concept/src/
    # final-collage.png. Слой из Figma отдаётся всего в 1024 px
    # и отзеркаленным — если его скачать, он затрёт хороший файл.
    # Хеш оставлен на память, строка закомментирована.
